...
<head>
	...
	<script src="../../js/arvorePastas.js" type="text/javascript" /> <!-- JS PARA A LISTAGEM DE PASTAS PAGINA PRINCIPAL -->
	<script src="../../js/checkbox.js"     type="text/javascript" /> <!-- JS PARA FAZER COM QUE SEJA SELECIONADOS TODOS OS ITEM CHECKBOX -->
	<!-- SCRIPTS FIM -->
